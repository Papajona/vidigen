...
export default {
  async fetch(request, env) {
    ...
    // Same-origin production gateway liveness probe.
    // This route is valid on every hostname served by this Worker, including the
    // workers.dev URL, so domain binding cannot silently break the status indicator.
    ...
    // already-verified Cloud Run gateway.
