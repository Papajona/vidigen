...
function App(){
 ...
 function rate(n){if(!history.length){setStatus('Generate a result before rating it.');return}setHistory(h=>h.map((x,i)=>i===0?{...x,rating:n}:x));setStatus(`Feedback saved: ${n}/5.`)}
